  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <BaseDialog.Popup
        ...
        className={cn(
          'fixed z-150 grid w-full bg-popover text-popover-foreground sm:max-w-[calc(100%-2rem)]',
      ...
      >
        {children}
        {showCloseButton && (
          <DialogClose className="absolute top-4 right-4 rounded-xs text-muted-foreground opacity-50 ring-offset-popover transition-opacity hover:opacity-100 focus:ring-[3px] focus:ring-ring focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4">
            <XIcon />
